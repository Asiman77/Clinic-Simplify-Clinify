...
class DepartmentControllerTest {
        ...
        void getAllDepartments_ShouldReturnOk() throws Exception {
                DepartmentResponse response = new DepartmentResponse(1L, "Cardiology", "Heart-related treatments",
                                true);
        ...
        void createDepartment_ShouldReturnCreated_WhenUserIsAdmin() throws Exception {
                CreateDepartmentRequest request = new CreateDepartmentRequest("Cardiology", "Heart-related treatments",
                                true);
                DepartmentResponse response = new DepartmentResponse(1L, "Cardiology", "Heart-related treatments",
                                true);
        ...
        void updateDepartment_ShouldReturnOk_WhenUserIsAdmin() throws Exception {
                UpdateDepartmentRequest request = new UpdateDepartmentRequest("Neurology", "Brain-related treatments",
                                true);
